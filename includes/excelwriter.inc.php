            ...
            $header = <<<EOH
                ...
                <!--[if gte mso 9]><xml>
                 <o:DocumentProperties>
                  <o:LastAuthor>EINAR</o:LastAuthor>
...
EOH;
        ...
        */
        function writeCol($value)
        {
            ...
            fwrite($this->fp,"<td class=style0>$value</td>");
        }
		
		function writeColHeader($value,$width=100)
        {
            if($this->state!="OPENED")
            {
                $this->error="Error : Please open the file.";
            ...
            fwrite($this->fp,"<td class=styleHeader width=$width >$value</td>");
        }
    }
?> 